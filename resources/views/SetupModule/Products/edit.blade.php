        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST">
            ...
            <div class="form-group form-row">
                <div class="col-6">
                    ...
                    <input type="text" name="name" id="name" autofocus placeholder="Product Name" class="form-control" value="{{ $product->name }}">
                    @error('name')
                ...
                <div class="col-5">
                    ...
                    <input type="text" name="formulation" id="formulation"  placeholder="Product Formulation" class="form-control" value="{{ $product->formulation }}">
                    @error('formulation')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                </div>
                <div class="col-11">
                    ...
                    <input type="text" name="description" id="description" placeholder="Product description" class="form-control" value="{{ $product->description }}">
                    @error('description')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="number" id="pack_size" name="pack_size" class="form-control" value="{{ $product->pack_size }}" >
                    @error('pack_size')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <input type="text" name="product_barcode" class="form-control" value="{{ $product->product_barcode }}" >
                ...
                <div class="col-3" style="margin-top:35px">
                    <div class="custom-control custom-switch custom-control-warning">
                        <input type="checkbox" class="custom-control-input" id="example-sw-custom-success1" name="narcotics_lock" value="1" {{ $product->narcotics_lock ? 'checked' : '' }}>
           ...
           <div class="table-responsive">
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                    <tr>
                        <td class="form-group">
                            <input type="text" id="current_quantity" name="current_quantity" class="form-control" disabled value="{{ $product->current_quantity }}" >
                        </td>
                        <td class="form-group">
                            <input type="text" id="pack_purchase_price" name="pack_purchase_price" class="form-control" value="{{ $product->pack_purchase_price }}">
                        </td>
                        <td class="form-group">
                            <input type="text" id="single_purchase_price"  name="single_purchase_price" class="form-control" value="{{ $product->single_purchase_price }}">
                        </td>
                        <td class="form-group">
                            <input type="text" id="pack_avg_purchase_price" name="pack_avg_purchase_price" class="form-control" value="{{ $product->pack_avg_purchase_price }}">
                        </td>
                        <td class="form-group">
                            <input type="text" id="pack_sale_price" name="pack_sale_price" class="form-control" value="{{ $product->pack_sale_price }}">
                        </td>
                        <td class="form-group">
                            <input type="text" id="single_sale_price" name="single_sale_price" class="form-control" value="{{ $product->single_sale_price }}">
                        </td>
                        <td class="form-group">
                            <input type="text" id="single_avg_sale_price" name="single_avg_sale_price" class="form-control" value="{{ $product->single_avg_sale_price }}">
                        </td>
                        <td class="form-group">
            ...
            <button type="submit" class="btn btn-alt-primary">Update Product</button>
            </form>
    </div>
@endsection
